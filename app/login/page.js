...
const Login = () => {
  ...
  return (
    ...
    <div className="flex flex-col -z-2 bg-[#e4f4ff] items-center justify-between p-10 h-[93vh] w-[100vw]">
      ...
      <button className="mt-7 px-7 py-3 rounded-full text-white font-bold text-lg bg-[#2E7D32] active:translate-y-1 hover:-translate-y-0.5">
        Log In
      </button>
      <img src="/vit.png" width="1100" className="mt-10 opacity-15"></img>
